...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`lg:hidden fixed top-[73px] left-0 bottom-0 z-30 w-64 bg-white border-r border-slate-200 flex flex-col transform transition-transform duration-200 ${
