  ...
  // ─── SECTION 1: BUSINESS IDENTITY (Client-Facing) ───
  {
    ...
    questions: [
      ...
      },
      {
        ...
        helperText: "Enter the main website where your opt-in forms, landing pages, and contact forms are hosted. Carriers will check this URL to verify your business and opt-in flow.",
        required: true,
        clientFacing: true,
      },
    ],
