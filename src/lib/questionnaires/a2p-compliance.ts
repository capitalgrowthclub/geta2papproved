  ...
  // ─── SECTION 1: BUSINESS IDENTITY (Client-Facing) ───
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          "Service business — I provide a service (consulting, home services, legal, medical, coaching, agency, etc.)",
          "E-commerce — I sell physical or digital products online",
          "SaaS / Software — I sell software or a digital platform",
          "Real estate — buying, selling, property management, or rentals",
          "Restaurant, salon, or local retail — walk-in or appointment-based",
          "Education or coaching — courses, tutoring, training programs",
          "Nonprofit or church — donations, events, community outreach",
        ],
        helperText: "This helps us tailor your documents and sample messages to your business type. Pick the closest match.",
        required: true,
        clientFacing: true,
        allowOther: true,
      },
