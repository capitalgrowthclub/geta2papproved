...
26. MULTIPLE OPT-IN LOCATIONS: If the questionnaire shows multiple opt-in locations (e.g., "Website contact form" AND "Landing page form"), the Privacy Policy "How to Opt In" section must reference ALL of them — not just one. NEVER use "exclusively" or "solely" when there are multiple opt-in points. Use language like "SMS consent is obtained through unchecked opt-in checkboxes on our web forms, including [list all locations]." If only ONE opt-in location exists, you can be specific about that single location.
27. STOP KEYWORD — EXACT PHRASING: The opt-out phrase is ALWAYS "Reply STOP to opt out." — NEVER "Reply STOP to unsubscribe", NEVER "Reply STOP to cancel", NEVER "Reply STOP to stop receiving messages." The word "opt out" is mandatory everywhere it appears in any document. "Unsubscribe" will cause a carrier rejection. This applies to: consent disclosures, opt-out sections, sample messages, and all SMS-related language.
