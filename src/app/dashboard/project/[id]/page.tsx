            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 mt-1">
                  The documents generated by GetA2PApproved are intended to assist with A2P 10DLC registration and are not a substitute for professional legal advice.
                  We do not guarantee A2P approval and are not liable for the use of generated documents.
                  We strongly recommend consulting with a qualified attorney before publishing any legal documents on your website.
                  By using this service, you acknowledge that the decision to use these documents is solely your responsibility.
                </p>
              </div>
            </div>
          </div>
