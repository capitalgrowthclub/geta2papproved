(function () {
  ...
  fetch(url)
    ...
    .then(function (data) {
      ...
      // Inject the document HTML
      container.innerHTML = data.html;

      // Append powered-by footer
      var footer = document.createElement("p");
      footer.style.cssText =
        "margin-top: 2em; font-size: 0.8em; color: #9ca3af; text-align: center;";
      footer.innerHTML =
        'Generated by <a href="' +
        ORIGIN +
        '" target="_blank" rel="noopener noreferrer" style="color: #14b8a6; text-decoration: underline;">GetA2PApproved.com</a>';
